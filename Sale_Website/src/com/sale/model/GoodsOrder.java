...
public class GoodsOrder  implements java.io.Serializable {
	...
	/** minimal constructor */
    public GoodsOrder(Integer orderId, Custom custom, String orderAdr, Double orderMoney, String acceptName, String acceptPhone) {
    ...
    /** full constructor */
    public GoodsOrder(Integer orderId, Custom custom, Seller seller, String orderAdr, String orderState, String paymentState, Double orderMoney, String acceptName, String acceptPhone, Timestamp orderDate) {
        this.orderId = orderId;
        this.custom = custom;
        this.seller = seller;
        this.orderAdr = orderAdr;
