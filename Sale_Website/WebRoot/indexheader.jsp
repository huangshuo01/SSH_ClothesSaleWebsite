		...
		<div class="header">
			<ul id="QuickMenu">
				...
				<s:if test="#session.Type==null">
					...
					<li class="my_account"><a href="register.jsp" id="reg">注册</a>
					</li>
				</s:if>
				<s:else>
					<s:if test="#session.Type=='Seller'">
						...
						<li class="my_account"><a
							href="Goods!findGoodsListBySeller.action" id="reg">管理</a></li>
						<li class="my_account"><a href="Login!exit.action" id="reg">退出</a>
						</li>
					</s:if>
					<s:if test="#session.Type=='Custom'">
						<li class="my_account"><s:property value="#session.Id" /></li>
						<li class="my_account"><a href="#" id="reg">管理</a></li>
						<li class="my_account"><a
							href="ShopCart!findShopCartByCustomId.action" id="reg">购物车</a></li>
						<li class="my_account"><a href="Login!exit.action" id="reg">退出</a>
						</li>
					</s:if>
			...
			<div id="nav">
				<ul class="mian_nav">
					<li class="nav_index"><a href="indexshop.jsp" title="">首页</a>
					</li>
