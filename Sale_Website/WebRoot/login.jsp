	...
	<DIV
		...
		<form name="loginfrm" action="" method="post">
			...
			<P style="padding: 0px 0px 10px;">
				...
				<input type="radio" name="radiobutton1" value="seller">商户<input
					type="radio" name="radiobutton1" value="adminer">管理员
			</P>
			<DIV
				style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
				<P style="margin: 0px 35px 20px 45px;">
					<SPAN style="float: left;"><A
						style="color: rgb(204, 204, 204);" href="register.jsp">忘记密码?</A> </SPAN>
					<SPAN style="float: right;"><A
						style="color: rgb(204, 204, 204); margin-right: 10px;"
						href="register.jsp">注册</A> <input type="submit"
